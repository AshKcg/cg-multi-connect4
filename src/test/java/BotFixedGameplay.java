...
public class BotFixedGameplay {
    ...
    private static final int draw[] = {0, 1, 2, 3, 4, 5, 6, 7, 8, 0, 1, 2, 0, 8, 7, 6, 8, 3, 4, 5, 7, 4, 1, 8, 5, 0, 3, 2, 8, 6, 0, 1, 2, 7, 6, 4, 3, 0, 5, 8, 4, 1, 4, 7, 7, 6, 1, 2, 4, 3, 7, 5, 8, 5, 0, 3, 1, 3, 2, 5, 6, 6, 2};
    ...
    private static final int p0_filled_column[] = {0, 1, 1, 1, 1, 1, 1, 1, 1};
    private static final int p1_filled_column[] = {0, 0, 0, 0, 0, 0, 0, 0};
    ...
    private static final int p0_out_of_bounds[] = {0, 0, 0, 0, 9, 0};
    private static final int p1_out_of_bounds[] = {0, 0, 0, 0, 0, 10};
    private static final int starting_replay[] = {1, 7, 2, 6, 3, 5, 4};
    ...
    private static final int ACTIONS[] = p0_bad_output_in_its_third_play;
